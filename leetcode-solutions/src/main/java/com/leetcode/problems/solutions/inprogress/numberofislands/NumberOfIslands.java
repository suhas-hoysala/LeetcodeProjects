package com.leetcode.problems.solutions.inprogress.numberofislands;
import java.util.*;

import com.leetcode.problems.commons.utils.ImportJson;
...
public class NumberOfIslands {
    public static void main(String[] args) {
        ...
        char[][] grid = ImportJson.getCharMatrix(args[0]);
